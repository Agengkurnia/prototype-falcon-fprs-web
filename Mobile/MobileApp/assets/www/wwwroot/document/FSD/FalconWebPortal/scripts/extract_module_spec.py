...
def dashboard_section(chapter: str, sub: int, mod: dict) -> str:
    lines = [
        ...
        '|------------|-----------|------|-----------|---------|----------|------------|',
        '| Judul halaman | `.home-title` | Text (heading) | — | Home Page \\| Man Power GT | — | H2 di `#app-content` |',
...
def module_section(chapter: str, sub: int, mod: dict, br_counters: dict, all_rules: list) -> str:
    ...
    lines = [
        ...
        '',
        f'Modul **{short_label}** merupakan bagian dari Web Portal Man Power GT. '
        f'Tipe UI: **{ui_type}**. '
