...
const MODULES = {
  ...
  'M-HOME':    { name:'Beranda', tcs:[
    {id:'TC-HOME-01', sc:'Periode Penjualan & 4 menu utama',  data:'-',  exp:'Banner Periode Penjualan + 4 kartu menu',        act:'4 menu feedback PDF tampil ✓',           status:'PASS',notes:''},
    ...
    {id:'TC-HOME-04', sc:'Tombol Rute Kunjungan Hari Ini', data:'-', exp:'Buka visit_list.html',                  act:'visit_list terbuka ✓',              status:'PASS',notes:''},
    {id:'TC-HOME-05', sc:'Nav → Cek Stok dan Belanja Stokis', data:'-', exp:'Buka product_catalog.html',         act:'product_catalog terbuka ✓',         status:'PASS',notes:''},
    {id:'TC-HOME-06', sc:'Nav → Faktur Penjualan',        data:'-',  exp:'Buka invoice_list?backTo=home',         act:'invoice_list terbuka ✓',            status:'PASS',notes:''},
    {id:'TC-HOME-07', sc:'Nav → Visit',                   data:'-',  exp:'Buka visit_list.html',                  act:'visit_list terbuka ✓',              status:'PASS',notes:''},
    {id:'TC-HOME-08', sc:'Nav → Sinkronisasi Data',       data:'-',  exp:'Buka sync_detail.html',                 act:'sync_detail terbuka ✓',             status:'PASS',notes:''},
    {id:'TC-HOME-09', sc:'FAB 2 opsi di visit_list',      data:'-',  exp:'Tambah Kunjungan & Tambah Outlet',      act:'FAB speed dial tampil ✓',           status:'PASS',notes:''},
  ...
  'M-VISIT':   { name:'Rute Kunjungan', tcs:[
    ...
    {id:'TC-VISIT-04',sc:'Mulai Visit',                         data:'-', exp:'State → Sedang Visit',                              act:'State berubah ✓',                                status:'PASS',notes:''},
